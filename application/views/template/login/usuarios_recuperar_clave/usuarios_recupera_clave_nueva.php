<form action="<?= base_url('usuarios/usuarios_recupera_clave/usuarios_recupera_clave_nueva/usuarios_recupera_clave_nueva_actualizacion')?>" id="frm_recupera_clave_nueva" role="form" method="post" accept-charset="utf-8">
    <?=$token;?>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6 col-md-12">
                                <div class="form-section">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <h2><?=$this->lang->line('recupera_clave_nueva_titulo')?></h2>
                                        </div>                                    
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-recovery animate__animated animate__zoomIn" id="axa-form">
                                                <p><?=$this->lang->line('recupera_clave_nueva_instrucciones')?></p>  
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="botones animate__animated animate__zoomIn">
                                                <button type="button" id="button_crea_clave" class="btn btn-axalta btn-lg" pb-role="submit"><?=$this->lang->line('recupera_clave_msg_btn_guardar')?></button>
                                            </div>
                                        </div>
                                    </div>                    
                                </div>
...
<script>
    $(document).ready(function(){
        ...
        $('#button_crea_clave').click(function() { recupera_clave_nueva_actualizacion(); });
    ...
    function recupera_clave_nueva_actualizacion(){
                ...
                case 0:
                    $('#clave_nueva').focus();
                        Swal.fire({
                            icon: 'error',
                            title: '',
                            text: '<?=$this->lang->line('recupera_clave_nueva_valida_clave_nueva_confirma_no_concuerdan')?>'
                        });
                    break;
                case 1:
                    Swal.fire({
                        title: '',
                        html: '<?=$this->lang->line('recupera_clave_nueva_actualizada')?>',
                        icon: 'success',
