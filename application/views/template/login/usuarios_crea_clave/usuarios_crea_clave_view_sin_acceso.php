                            ...
                            <div class="animate__animated animate__zoomIn">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <p><?=$this->lang->line('usuarios_crea_clave_msg_acceso_denegado')?></p>
                                        </div>                                    
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="botones">
                                                <a href="<?php echo base_url("login").$this->urlVersionSite ?>"><button type="button" class="btn btn-axalta"><?=$this->lang->line('usuarios_crea_clave_btn_login')?></button></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>                
