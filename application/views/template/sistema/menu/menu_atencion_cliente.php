      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown" id="nav_catalogos">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                ...
                <li><a class="dropdown-item" href="<?php echo base_url("Construccion").$this->urlVersionSite ?>"><?=$this->lang->line('menu_submenu_admin_tarjetas')?></a></li>
                ...
                <li><a class="dropdown-item" href="<?php echo base_url("CargaMultimedios").$this->urlVersionSite ?>"><?=$this->lang->line('menu_submenu_admin_carga_multimedia')?></a></li>
                <li><a class="dropdown-item" href="<?php echo base_url("CortesVentasPromociones").$this->urlVersionSite ?>"><?=$this->lang->line('menu_submenu_admin_cortes')?></a></li>
                <li><a class="dropdown-item" href="<?php echo base_url("CambioEstatusVentas").$this->urlVersionSite ?>"><?=$this->lang->line('menu_submenu_auditorias_cambio_estatus')?></a></li>                 
            </ul>
        </li>     
        <li class="nav-item dropdown" id="nav_catalogos">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                <li><a class="dropdown-item" href="<?php echo base_url("AuditoriaVentas").$this->urlVersionSite ?>"><?=$this->lang->line('menu_submenu_auditorias_ventas')?></a></li> 
                <li><a class="dropdown-item" href="<?php echo base_url("AuditoriaPromociones").$this->urlVersionSite ?>"><?=$this->lang->line('menu_submenu_auditorias_promociones')?></a></li>                  
            </ul>
        </li>    
        <li class="nav-item dropdown" id="nav_catalogos">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                ...
                <li><a class="dropdown-item" href="<?php echo base_url("ReporteTarjetas").$this->urlVersionSite ?>"><?=$this->lang->line('menu_submenu_reportes_tarjetas_entregadas')?></a></li> 
                ...
                <li><a class="dropdown-item" href="<?php echo base_url("ReporteVentasAuditoria").$this->urlVersionSite ?>"><?=$this->lang->line('menu_submenu_reportes_ventas_auditoria')?></a></li>
                ...
                <li><a class="dropdown-item" href="<?php echo base_url("ReporteRecuperacionClave").$this->urlVersionSite ?>"><?=$this->lang->line('menu_submenu_reportes_recuperacion_clave')?></a></li>
