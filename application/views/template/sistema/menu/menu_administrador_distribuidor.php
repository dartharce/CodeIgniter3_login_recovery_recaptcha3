...
?>
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        ...
        <li class="nav-item" id="nav_participantes"><a class="nav-link" aria-current="page" href="<?php echo base_url("Participantes").$this->urlVersionSite ?>"><?=$this->lang->line('menu_submenu_admin_usuarios')?></a></li>
        ...
        <li class="nav-item" id="nav_reposicion_producto_captura"><a class="nav-link" aria-current="page" href="<?php echo base_url("ReposicionProductoCaptura").$this->urlVersionSite ?>"><?=$this->lang->line('menu_reposicion_prodcutos')?></a></li>
